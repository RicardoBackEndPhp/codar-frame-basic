...
if (strpos(url(), "localhost")) {
    ...
    $cssDir = scandir($place."/themes/" . CONF_VIEW_ADMIN . "/assets/css");
    foreach ($cssDir as $css) {
        $cssFile = $place . "/themes/" . CONF_VIEW_ADMIN . "/assets/css/{$css}";
    ...
    //Minify CSS
    $minCSS->minify($place . "/themes/" . CONF_VIEW_ADMIN . "/assets/style.min.css");
    ...
    $minJS->add($place . "/node_modules/startbootstrap-sb-admin-2/vendor/chart.js/Chart.min.js");
    $minJS->add($place . "/shared/js/charts/chart-area.js");
    $minJS->add($place . "/shared/js/charts/chart-pie.js");
    $minJS->add($place . "/shared/js/main.js");
    
    //Pega o js do theme
    $jsDir = scandir($place . "/themes/" . CONF_VIEW_ADMIN . "/assets/js");
    foreach ($jsDir as $js) {
        $jsFile = $place . "/themes/" . CONF_VIEW_ADMIN . "/assets/js/{$js}";
    ...
    //Minify JS
    $minJS->minify($place . "/themes/" . CONF_VIEW_ADMIN . "/assets/scripts.min.js");
}
